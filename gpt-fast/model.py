...
transformer_configs = {
    "Qwen-7B": dict(n_layer=32, n_head=32, dim=4096, vocab_size=151936, merge_qkv=True),
    "Qwen-14B": dict(n_layer=40, n_head=40, dim=5120, vocab_size=152064, merge_qkv=True),
    "Qwen-72B": dict(n_layer=80, n_head=64, dim=8192, vocab_size=152064, merge_qkv=True, rope_base=1000000, intermediate_size=24576),
...
def apply_rotary_emb(x: Tensor, freqs_cis: Tensor) -> Tensor:
    ...
    x_out2 = torch.stack(
        [
            x[..., : x.shape[-1] // 2] * freqs_cis[..., 0] - x[..., x.shape[-1] // 2 :] * freqs_cis[..., 1],
            x[..., x.shape[-1] // 2 :] * freqs_cis[..., 0] + x[..., : x.shape[-1] // 2] * freqs_cis[..., 1],
        ],
        -1,
    )
